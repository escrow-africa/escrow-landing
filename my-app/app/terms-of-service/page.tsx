...
const outlineItems = [
  { title: "Acceptance of Terms & Eligibility", desc: "The legal binding agreement you enter by using the platform and requirements for age and entity eligibility." },
  { title: "Escrow Services & Fee Structure", desc: "Detailed breakdown of transaction flows, inspection periods, payouts, and service fee charges." },
  { title: "User Account Responsibilities", desc: "Rules for securing login details, updating credentials, and managing personal/corporate account profiles." },
  { title: "Prohibited Activities & Usage", desc: "Explicit list of banned transactions, goods, illegal services, and fraudulent behaviors." },
  { title: "Limitation of Liability", desc: "Our formal liability disclaimers regarding technical outages, external logistics, or third-party acts." },
  { title: "Termination & Suspension Rules", desc: "Conditions under which Escrow Africa may restrict, suspend, or terminate user access to the services." }
];
    ...
    <main className="min-h-screen bg-gray-50/50 py-16 md:py-24">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div>
              ...
              <p className="text-gray-300 leading-relaxed text-sm md:text-base">
                We are currently finalizing the official legal text and terms for our <strong>Terms of Service</strong>. 
                This agreement is designed to govern your access to and use of Escrow Africa services. The complete document will be published shortly.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-3xl p-8 md:p-12 shadow-xs">
          <h3 className="text-lg font-bold text-[#062B22] mb-6">What this agreement will cover:</h3>
