...
const managementTeam = [
  ...
  { name: "Olude Fiyinfoluwa", role: "Head of Engineering", image: "/fiyin.jpeg", linkedin: "https://linkedin.com/in/oludefiyinfoluwa", bio: "Olude Fiyinfoluwa is a software engineer specializing in building scalable, high-performance digital systems across web and mobile platforms. He has extensive experience developing full-stack applications with a strong focus on clean architecture and reliability. His work spans backend systems, payment and subscription infrastructures, and developer tooling, where he delivers robust, production-grade solutions." },
  { name: "Odubela Lawreta", role: "Head of Marketing and Sales", image: "/lawreta.jpeg", linkedin: "https://www.linkedin.com/in/lawrita-odubela?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app", bio: "Lawrita Odubela is a marketing and brand communications professional with a growing track record in developing and executing insight-driven campaigns across the consumer and lifestyle space for top brands like Nivea. She holds a First-Class degree in Mass Communication from Trinity University, Lagos, with a specialization in Advertising, Experiential Marketing and Public Relations." },
  { name: "Anagha Madeleine", role: "Head of product", image: "/madeline.jpeg", linkedin: "https://www.linkedin.com/in/anagha-madeleine?utm_source=share_via&utm_content=profile&utm_medium=member_android" },
  { name: "Adebiyi Esther", role: "Head of Media and Publicity", image: "/P1.jpeg", linkedin: "https://www.linkedin.com/in/adebiyi-esther-966373364?utm_source=share_via&utm_content=profile&utm_medium=member_ios", bio: "Adebiyi Esther is a social media manager and content creator with a growing track record in developing and executing data-driven content strategies for brands across different niches. She specializes in creating engaging digital content that drives visibility, audience growth, and conversions. She is passionate about helping brands build strong online presence in the social media space." },
...
const engineeringTeam = [
  { name: "Idundun Louis", role: "Founder/CTO", image: "/Louise.jpeg", bio: "Louis Idundun is a software engineer with a background in civil engineering. He specializes in building scalable backend systems and fintech products. With experience across engineering, operations, and product development, he leads EscrowAfrica NG as Founder & CTO, building the future of trusted online commerce." },
  { name: "Olude Fiyinfoluwa", role: "Head of Engineering", image: "/fiyin.jpeg", linkedin: "https://linkedin.com/in/oludefiyinfoluwa", bio: "Olude Fiyinfoluwa is a software engineer specializing in building scalable, high-performance digital systems across web and mobile platforms. He has extensive experience developing full-stack applications with a strong focus on clean architecture and reliability. His work spans backend systems, payment and subscription infrastructures, and developer tooling, where he delivers robust, production-grade solutions." },
  { name: "Okoduwa Joy", role: "Lead Frontend Engineer", image: "/joy.jpeg", bio: "Okoduwa Joy is a frontend developer specializing in building modern, scalable, and user-friendly web applications. A First Class graduate of Aquaculture and Fisheries from the University of Ilorin, she has contributed to several projects, working on UI development, state management, and API integration to deliver seamless digital experiences." },
];
