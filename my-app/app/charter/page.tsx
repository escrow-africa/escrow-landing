...
const outlineItems = [
  { title: "Organizational Mission & Scope", desc: "Our core corporate purpose and the boundary limits of our digital escrow service offerings." },
  { title: "Governance & Leadership Principles", desc: "Guidelines detailing the structure, responsibilities, and accountability of our executive leadership team." },
  { title: "Code of Ethics & Professional Conduct", desc: "Mandatory ethical standards expected of all board members, executives, and employees." },
  { title: "Operational Standards & Integrity", desc: "Standard operating rules governing fund handling, customer support quality, and platform availability." },
  { title: "Stakeholder Relations & Accountability", desc: "Our formal commitment to transparency and communication with customers, partners, and regulators." },
  { title: "Governance Auditing & Reporting", desc: "How we regularly measure our alignment with this charter and publish our performance metrics." }
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#062B22] text-white rounded-3xl p-8 md:p-10 shadow-md mb-8 relative overflow-hidden">
          ...
          <div className="flex items-start gap-4 relative z-10">
            ...
            <div>
              <h2 className="text-xl font-bold mb-2 text-[#F3B659]">Charter Finalization in Progress</h2>
              <p className="text-gray-300 leading-relaxed text-sm md:text-base">
                We are currently finalizing the official text of our corporate <strong>Charter</strong>. 
                This document defines our core operating frameworks and corporate structure. The finalized document will be posted here soon.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-100 rounded-3xl p-8 md:p-12 shadow-xs">
          <h3 className="text-lg font-bold text-[#062B22] mb-6">What this charter will cover:</h3>
